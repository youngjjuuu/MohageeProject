...
public class tbComment implements Serializable{
   ...
   public tbComment(int bcNo, int bNo, int userNo, String bcContent, Date bcDate, int bcLevel, String bcStatus,
   ...
   public tbComment(int bNo, int userNo, String bcContent) {
      super();
      this.bNo = bNo;
      this.userNo = userNo;
      this.bcContent = bcContent;
   ...
   public tbComment(int bNo, int userNo, String bcContent, int bbcNo) {
      super();
      this.bNo = bNo;
      this.userNo = userNo;
      this.bcContent = bcContent;
   ...
   public String toString() {
      return "tbComment [bcNo=" + bcNo + ", bNo=" + bNo + ", userNo=" + userNo + ", bcContent=" + bcContent
