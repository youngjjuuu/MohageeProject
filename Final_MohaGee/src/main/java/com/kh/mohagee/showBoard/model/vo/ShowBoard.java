...
public class ShowBoard implements Serializable {
	...
	public ShowBoard(int bNo, int userNo, String bTitle, String bTag, String bContent, int cNo, String bUrl,
			...
			int favoriteCount, int commentCount, int bFileno) {
		super();
		this.bNo = bNo;
		this.userNo = userNo;
		this.bTitle = bTitle;
	...
	public String toString() {
		return "ShowBoard [bNo=" + bNo + ", userNo=" + userNo + ", bTitle=" + bTitle + ", bTag=" + bTag + ", bContent="
				...
				+ ", pRenamedFileName=" + pRenamedFileName + ", cLat=" + cLat + ", cLng=" + cLng + ", favoriteCount="
				+ favoriteCount + ", commentCount=" + commentCount + ", bFileno=" + bFileno + "]";
	}
