  ...
  <div class="page-header">
      ...
      <div class="container">
        <div class="col-md-4 ml-auto mr-auto">
          <div class="card card-login card-plain">
            <form onsubmit="return check();" class="form" method="POST" action="${ pageContext.request.contextPath }/member/findPw.do">
              ...
              <div class="input-group no-border input-lg">
                  <div class="input-group-prepend">
                    <span class="input-group-text">
                      <i class="fas fa-at users_circle-08"></i>
                    </span>
                  </div>
                  <input name="userId" id="userId" type="text" class="form-control" placeholder="Your Id">
                </div>
              <div class="input-group no-border input-lg">
                  <div class="input-group-prepend">
                    <span class="input-group-text">
              ...
              <div class="card-footer text-center" style="width: 310px; margin:auto;">
                <button class="btn btn-primary btn-round btn-lg btn-block">Go To Find Password</button>
              </div>
            </form>
            </div>
          </div>
    ...
    <script>
    	...
    	function check(){
			...
			var reg1 = /^[a-z][a-z0-9_-]{3,11}@([a-z\d\.-]+)\.([a-z\.]{2,6})$/;
